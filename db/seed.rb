...
film1 = Film.new({ 'title' => 'Requiem for a Dream', 'price' => 15, 'tickets_available' => 50})
film1.save()
film2 = Film.new({ 'title' => 'My Little Pony: Bigger, Longer, Uncut', 'price' => 12, 'tickets_available' => 50})
film2.save()
